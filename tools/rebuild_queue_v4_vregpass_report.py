...
def main():
    model_u1248 = ROOT / "results" / "unroll_test" / "sweep_u1248_queue_level4_vregpass_20260421" / "summary.csv"
    model_u36 = ROOT / "results" / "unroll_test" / "sweep_u36_queue_level4_vregpass_20260421" / "summary.csv"
    ...
    out_path = ROOT / "results" / "unroll_test" / "accuracy_report_queue_v4_vregpass_20260421.md"
    ...
    lines = []
    lines.append("# Unroll Accuracy Report (queue_level4 + vreg pass, 2026-04-21)")
    lines.append("")
    ...
    lines.append("Additional modeled queue/resource constraints for `queue_level4`:")
    ...
    lines.append("- global compute in-flight cap = `16` across both EXU ports")
    lines.append("- `EXQ` occupancy does **not** count already-issued inflight EXU ops")

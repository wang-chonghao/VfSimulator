...
def main():
    model_u1248 = ROOT / "results" / "unroll_test" / "sweep_u1248_queue_level4_vregpass_perexq8_20260421" / "summary.csv"
    model_u36 = ROOT / "results" / "unroll_test" / "sweep_u36_queue_level4_vregpass_perexq8_20260421" / "summary.csv"
    ...
    out_path = ROOT / "results" / "unroll_test" / "accuracy_report_queue_v4_vregpass_perexq8_20260421.md"
    ...
    lines = []
    lines.append("# Unroll Accuracy Report (queue_level4 + vreg pass, per-EXQ inflight cap, 2026-04-21)")
    lines.append("")
    ...
    lines.append("- per-EXQ in-flight issue cap = `8`")

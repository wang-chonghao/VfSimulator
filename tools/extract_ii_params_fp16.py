#!/usr/bin/env python3
"""Extract fp16 II timings from ii_*_fp16 native-sim dumps."""
...
CASE_RE = re.compile(r"^ii_([a-z0-9]+)_to_([a-z0-9]+)_fp16$")
...
def main() -> None:
    ...
    for rd in sorted(root.glob("ii_*_native_simexec")):
    ...
    with out.open("w", newline="", encoding="utf-8") as f:
        w = csv.DictWriter(f, fieldnames=["case", "prev", "cur", "measured", "run_dir"])
        w.writeheader()
        w.writerows(rows)

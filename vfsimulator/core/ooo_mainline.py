...
from vfsimulator.core import isu
from vfsimulator.core.isa_traits import is_load_op, is_store_op, uses_lsq, uses_shared_shq_credit
from vfsimulator.core.ooo import OoOCore, Uop, is_mem, is_vreg, make_mem_key
